...
class RegisterCoursesPage(BasePage):
    ...
    _payment_information_header = "//h2[@class='section-hed' and text()='Payment Information']"
    _cc_number_iframe_name = "__privateStripeFrame8"
    _cc_number = "//span//input[@name='cardnumber']"
    _cc_expiration_date_iframe_name = "__privateStripeFrame9"
    _cc_expiration_date = "//span//input[@name='exp-date']"
    _cc_cvc_iframe_name = "__privateStripeFrame10"
    _cc_cvc = "//span//input[@name='cvc']"
    _country_dropdown = "//div[@class='form-group']//select[@name='country_code']" # it may return 2 nodes
    _postal_code_iframe_name = "__privateStripeFrame11"
    _postal_code = "//span//input[@name='postal']"
    _enroll_button_final = "//div[@class='col-sm-6']//div[@class='spc__primary-submit']//button[@id='confirm-purchase']"
    ...
    def enter_postal_code(self,postal_code):
        ...
        self.send_Keys(postal_code, self._postal_code, locator_type="xpath")
        self.switch_to_default_content()

    def click_enroll_button_final(self):
        self.element_click(self._enroll_button_final, locator_type="xpath")
    ...
    def enter_card_details_postal_code(self, cc_number="", exp_date="", cvc="", postal_code=""):
        self.web_scroll(direction="down")
    ...
    def verify_enroll_button_final_disabled(self):
        result = not self.isEnabled(self._enroll_button_final, locator_type="xpath")
        return result

    def verify_enroll_button_final_enabled(self):
        result = self.isEnabled(self._enroll_button_final, locator_type="xpath")
        return result
    ...
    #def enroll_in_course(self, cc_number,
    # ):
